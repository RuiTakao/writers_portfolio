...
<div class="button-container default">
    <?= $this->Html->link('お問い合わせ項目の追加', ['action' => 'edit'], ['class' => 'button default']) ?>
    <?= $this->Html->link('表示順変更', ['action' => 'order'], ['class' => 'button default']) ?>
</div>
        ...
        <li class="card">
            <div class="head">
                ...
                <div class="button-container item">
                    ...
                    <?= $this->Form->postLink(Configure::read('button.delete'), ['controller' => 'Contacts', 'action' => 'delete', $item->id], ['class' => 'button item delete', 'confirm' => $delete_message]) ?>
                </div>
            </div>
